...
<head>
    ...
    <link href="http://BioMarket.com/css/creer.css" rel="stylesheet">
</head>

<body>
    <?php require('../public/header.php'); ?>
    <div class="container formContainer unique-color-dark">
        <form action="/App/devenir_livreur.php" method="post" class="text-center p-5" enctype="multipart/form-data">
