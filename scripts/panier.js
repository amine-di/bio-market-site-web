...
ajouterPanier = (id, btn) => {
    ...
    xhr.open('POST', 'http://192.168.1.4/bio_market/App/ajouterArticle.php', true);
...
subPanier = (id, btn) => {
    ...
    xhr.open('POST', 'http://192.168.1.4/bio_market/App/enleverArticle.php', true);
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.send("id=" + id);
}
...
delPanier = (id, btn) => {
    ...
    xhr.open('POST', 'http://192.168.1.4/bio_market/App/supprimerArticle.php', true);
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.send("id=" + id);
}
